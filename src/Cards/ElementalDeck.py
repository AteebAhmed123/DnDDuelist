...
class ElementalDeck(AllDecks):
    ...
    def __init__(self, screen):
        super().__init__(screen, 5, "./Assets/Cards/ElementalDeck.png", (0, 0, 170, 220))
        self.rect = None  # Will be set during render
    ...
    def render(self, center_x, y_position):
        ...
        # Update the rect for click detection
        self.rect = pygame.Rect(deck_x, deck_y, deck_image.get_width(), deck_image.get_height())
    ...
    def handle_click(self, mouse_pos):
        """Handle click on the ElementalDeck"""
        if self.rect and self.rect.collidepoint(mouse_pos):
            # Create and return an ElementalWeather card when clicked
            return ElementalWeather(self.screen)
        return None
