...
class MagicMissile(SpellBase):
    ...
    animation_frames = [
        (26, 33, 52, 36),    # Frame 1
        (126, 33, 52, 36),   # Frame 2
        (226, 33, 52, 36),   # Frame 3
        (326, 33, 52, 36),   # Frame 4
        (426, 33, 52, 36),   # Frame 5
        (526, 33, 52, 36),   # Frame 6
        (626, 33, 52, 36),   # Frame 7
        (726, 33, 52, 36),   # Frame 8
        (826, 33, 52, 36)    # Frame 9
    ]
    ...
    def __init__(self, screen):
        ...
        self.damage = 6  # Regular damage amount
    ...
    def animate_spell(self, caster, target):
        ...
        for missile in self.missiles:
            ...
            missile['x'] = self._quadratic_bezier(
                missile['start_x'], missile['control_x'], missile['target_x'], t)
            missile['y'] = self._quadratic_bezier(
                missile['start_y'], missile['control_y'], missile['target_y'], t)
